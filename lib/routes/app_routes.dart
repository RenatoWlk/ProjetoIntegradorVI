...
import 'package:projeto_integrador_6/screens/top_purchased_items_screen.dart';
...
class AppRoutes {
  ...
  static const String topPurchasedItems = '/top_purchased_items';
  ...
  static Map<String, WidgetBuilder> define() {
    return {
      ...
      topPurchasedItems: (context) => const TopPurchasedItemsScreen(),
    };
  }
}
